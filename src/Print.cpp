...
Value *Print::generate(FunctionImpl *func, BasicBlock *block, BasicBlock *allocblock) {
	/*vector<Value*> args;
	...
	new StoreInst(lexp, ptr_aux, false, block);
	...
	//TODO: Implement a new way of print (serial interface with simavr!)
	return NULL;
}
