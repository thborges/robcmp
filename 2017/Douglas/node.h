...
private: 
	Node *coordX, *coordY, *coordZ, *coordI, *coordJ;

public: 
	Coord (Node* x, Node* y, Node* z): coordX(x), coordY(y), coordZ(z){}
	Coord (Node* x, Node* y, Node* z, Node* i, Node* j): coordX(x), coordY(y), coordZ(z), coordI(i), coordJ(j){}
	Value *generate (Function *func, BasicBlock *block){
	coordX->generate(func, block);
	coordY->generate(func, block);
	coordZ->generate(func, block);
	coordI->generate(func, block);
		return coordJ->generate(func, block);
